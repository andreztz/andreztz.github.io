...
Existem duas maneiras de fazer backup de drivers de dispositivos usando ferramentas internas do Windows. Uma maneira é usar o dism.exe ("Deployment Image Servicing and Management Tool") no prompt do Windows, a outra é usar o PowerShell que de qualquer forma vai chamar o dism em background.
